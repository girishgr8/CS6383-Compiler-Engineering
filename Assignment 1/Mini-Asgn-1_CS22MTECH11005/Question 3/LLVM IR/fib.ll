; ModuleID = '../../../Assignment1/fib.cpp'
source_filename = "../../../Assignment1/fib.cpp"
...
@.str = private unnamed_addr constant [10 x i8] c"fib(n) = \00", align 1
...
entry:
  ...
  %call1 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i64 0, i64 0))
  %0 = load i32, i32* %n, align 4
  %call2 = call noundef i32 @_Z3fibi(i32 noundef %0)
  %call3 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEi(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %call1, i32 noundef %call2)
  ret i32 0
}
