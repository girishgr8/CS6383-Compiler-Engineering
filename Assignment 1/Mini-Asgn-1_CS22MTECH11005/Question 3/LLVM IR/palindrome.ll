...
for.body:                                         ; preds = %for.cond
  ...
  %call1 = call noundef nonnull align 8 dereferenceable(16) %"class.std::basic_istream"* @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_RS3_(%"class.std::basic_istream"* noundef nonnull align 8 dereferenceable(16) @_ZSt3cin, i8* noundef nonnull align 1 dereferenceable(1) %arrayidx)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  ...
  %call2 = call noundef zeroext i1 @_Z12isPalindromeiPc(i32 noundef %7, i8* noundef %vla)
  %call3 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEb(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i1 noundef zeroext %call2)
  store i32 0, i32* %retval, align 4
...
declare dso_local noundef nonnull align 8 dereferenceable(16) %"class.std::basic_istream"* @_ZStrsIcSt11char_traitsIcEERSt13basic_istreamIT_T0_ES6_RS3_(%"class.std::basic_istream"* noundef nonnull align 8 dereferenceable(16), i8* noundef nonnull align 1 dereferenceable(1)) #1

declare dso_local noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEb(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8), i1 noundef zeroext) #1
